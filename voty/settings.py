...
PLATFORM_POLICY_STALE_DISCUSSION_LIST = config.get("platform_policy_settings", "PLATFORM_POLICY_STALE_DISCUSSION_LIST").split(",")
PLATFORM_POLICY_STALE_VOTE_LIST = config.get("platform_policy_settings", "PLATFORM_POLICY_STALE_VOTE_LIST").split(",")
